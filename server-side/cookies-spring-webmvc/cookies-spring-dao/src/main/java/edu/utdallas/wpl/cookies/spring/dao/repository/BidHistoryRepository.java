...
import edu.utdallas.wpl.cookies.spring.dao.orm.BidHistoryPk;

@Repository
public class BidHistoryRepository  extends GenericDAORepositoryImpl<BidHistoryEntity, BidHistoryPk> {
